...
, 'Excavating contractors', 'Farmers', 'Industrial plants', 'Other heavy-duty']
				...
				$scope.sevenHundredEleven = {
					benefits: ['Extends transission life and reduces the cost of operation', 'Longer seal life and extended drain and service intervals'
, 'Protect and extends the life of synchronizers', 'Extends component and fluid life', 'Minimizes wear during severe service'
, 'Reduces wear at cold starts and improves shifting', 'When used with LOA it will lower operating costs', 'Helps to improve fuel economy and lower operating costs']
					, markets: ['Agricultural', 'Automotive', 'Food Storage', 'Heavy Construction', 'Industrial Equipment', 'Mining', 'Transportation', 'Trucking']
					, applications: ['Heavy duty manual transmissions where extended service drain intervals required', 'On highway commercial light trucks'
, 'On highway heavy duty trucks', 'City buses', 'Vans', 'Delivery vehicles', 'Construction', 'Mining', 'Agriculture']
					, technical_data: [
						{
				...
				$scope.sevenHundredTwelve = {
					benefits: ['Insures maximum performance and life for latest generation of high efficiency planetary transmissions requiring Allison® TES-295, TES-468, C-4, Dexron® IIIH, Mercon®, Mercon V®, Jaso 1A or similar fluids'
, 'For standard or severe service in over-the-road conditions', 'Excellent shear stability, oxidation resistance, friction stability and wear control in extended service'
, 'Extends drain intervals beyond conventional oils', 'Insures smooth, positive shift quality, even in cold weather', 'Faster warm ups', 'Helps improve fuel economy'
, 'Unsurpassed protection against deposit formation, varnish, corrosion, sludge, wear and rust
'Exceeds performance of many OEM branded oils', 'Compatible with common seal and part materials', 'UV dye makes identification of leaks easy']
					, markets: ['Agricultural', 'Automotive', 'Food Storage', 'Government', 'Heavy Construction', 'Lumber/Forestry', 'Transportation', 'Trucking']
					, applications: ['Heavy duty ove-the-road construction equipment', 'City buses', 'Garbage trucks', 'Dump trucks'
, 'Redi-mix concrete trucks', 'School buses', 'Motor coaches', 'Fire trucks', 'Ambulances', 'Police cars', 'Taxi fleets'
, 'Light truck and automobile market that requires higher viscosity transmission fluids']
					, technical_data: [
						{
...
, 'Improved shift quality, extended transmission life', 'Can replace DEXRON fluids in on-highway applications']
				...
				$scope.sevenHundredSeventeen = {
					benefits: ['Superior low temperature fluidity and reduced start-up wear', 'Prevents shrinkage of seals, elastomers, gaskets eliminating leakage and loss of fluid'
, 'Reduces potential maintenance expense of seal replacement', Gives a more uniform viscosity over a wide temperature range ',
'Superior thermal stability prevents “varnish” deposits on bearings and gearing', 'Better low temperature flow characteristics to help reduce start-up wear'
, 'Reduces oil thickening and degredation', 'Helps prevent sludge, varnish and carbon deposits that result from oxidation'
...
, 'Controls fluid level and minimizes loss through vent tube', 'Enables the oil to penetrate the surface for better lubrication'
, 'Helps prevent metal-to-metal contact and insures longer gear & bearing life'
, 'Improves film strength of the oil giving it the ability to withstand extreme pressures', Reduces gear teeth wear ','
...
, 'High temperature oxidation stability gives superior performance', 'High dielectric strength']
				...
				$scope.sevenHundredFour = {
					benefits: ['SWEPCO'
					s Syntheon synthetic base stock blends assure smooth even full power performance over a wide range of temperatures ',
...
, 'SWEPCO'
					s DIMONYL friction reducing additive reduces wear and energy requirements ']
...
, 'Perfect for screws, nuts, bolts, rollers, slideways, meat hooks, knives, cams, chains and other parts']
						...
						$scope.Concentrated Cleaner = {
							benefits: ['A Powerful General Purpose Cleaner', 'Leaves Surfaces Sparkling Clean With A Fresh New Smell', 'All You Do Is Add The Water'
, 'Active Chemical Ingredients Provide 3-Step Cleaning Cycle', 'Saves You Money & Time', 'Completely Safe To Use Anywhere'
, 'Easily Adapted To Your Present Cleaning Operations', 'Preserved biodegradability means long storage life', 'Exceeds US Specifications']
							, applications: ['SWEPCO Concentrated Cleaner is quick and easy to use. Just add to hot or cold water. No special mixing equipment needed. Effortless cleaning is achieved by using a mop, sponge, cloth, brush, dip bath and spray. For most cleaning, only one ounce (29.57 ml) is needed to a full gallon (3.79 liters) of water. Add slightly more for heavily soiled surfaces, according to recommendations printed on the container.
Note: See Product Container Label or Product Data Bulletin
								for complete application information.
								']
        , technical_data: [
									{
										pdf: 'http://swepcolube.com/sites/default/files/package_inserts/swepco_concentrated_cleaner_sales_brochure_j04004.pdf'
										, description: 'Data Sheet -- English'
            }
        ]
							};
